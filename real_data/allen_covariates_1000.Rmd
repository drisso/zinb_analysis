...
```{r zinb_bio_cov, dependson="zinb_bio", eval=FALSE}
...
```{r zinb_outliers, dependson="zinb_bio", eval=FALSE}
...
```{r write_out_bis, dependson=c("zinb", "zifa", "pca")}
save(zinb, zifa_fq, zifa_tmm, zifa_tc, zifa_raw, pc_deseq, pc_tmm, pc_fq, pc_tc, pc_raw, 
file="allen_covariates_1000.rda")
```
