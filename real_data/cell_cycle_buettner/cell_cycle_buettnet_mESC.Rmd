...
```{r}
set.seed(89303)
print(system.time(zinb <- zinbFit(Y = counts, K = 2, ncores = 2, epsilon = eps)))
```
...
eps = 10000
print(system.time(zinb_learnt_k3 <- zinbFit(Y = counts, K = 2, X = X, ncores = 2, epsilon = eps)))
```
...
print(system.time(zinb_learnt_k4 <- zinbFit(Y = counts, K = 2, X = X, ncores = 2, epsilon = eps)))
```
...
print(system.time(zinb_known_cl <- zinbFit(Y = counts, K = 2, X = X, ncores = 2, epsilon = eps)))
```
```{r}
...
print(system.time(zinb_len <- zinbFit(Y = counts, K = 2, V = V, ncores = 2, epsilon = eps)))
```
...
```{r}
X = model.matrix(~ labs_k3)
print(system.time(zinb_learnt_k3 <- zinbFit(Y = counts, K = 2, X = X, ncores = 2, V=V, epsilon = eps)))
```
