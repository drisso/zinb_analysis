...
plot(getW(zinb_sub1), pch=19, col=col2[droplevels(level2[subset])], main="ZINB; color-coded by inferred cell type")
...
plot(getW(zinb_sub2), pch=19, col=col2[droplevels(level2[subset])], main="ZINB w/batch correction")
```
