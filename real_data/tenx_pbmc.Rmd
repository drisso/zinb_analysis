...
zinb_df$CD3D <- exprs(gbm)[which(fData(gbm)[,2] == "CD3D"),]
zinb_df$NKG7 <- exprs(gbm)[which(fData(gbm)[,2] == "NKG7"),]
zinb_df$CD79A <- exprs(gbm)[which(fData(gbm)[,2] == "CD79A"),]
zinb_df$S100A8 <- exprs(gbm)[which(fData(gbm)[,2] == "S100A8"),]
zinb_df$S100A9 <- exprs(gbm)[which(fData(gbm)[,2] == "S100A9"),]
