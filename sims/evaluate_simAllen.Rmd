...
```{r corr25}
load("./datasets/simAllen_var2_z25_dist.rda")
...
```{r corr45}
load("./datasets/simAllen_var2_z45_dist.rda")
corr45 <- lapply(1:11, function(i) rowMeans(sapply(res, function(x) x[[i]])))
corr45 = do.call(cbind, corr45)
corr45 = data.frame(corr45, stringsAsFactors = F)
colnames(corr45) <- c("true W", paste0("zinb k=", 1:3), 
                      "PCA (k=2)", "PCA TC (k=2)", "PCA TMM (k=2)",
                      "PCA FQ (k=2)",
                      'ZIFA (k=2)', 'ZIFA TMM (k=2)', 'ZIFA FQ (k=2)')
corr45$pzero = .45
boxplot(corr45[,1:11], main="Correlation between true and estimated sample distances in W\npzero = 0.45", border=c(3, 1, 2, rep(1,10)), xlab="method", ylab="Correlation", las=2)
abline(h=1,lty = 2)
```


```{r corr75}
load("./datasets/simAllen_var2_z75_dist.rda")
corr75 <- lapply(1:10, function(i) rowMeans(sapply(res, function(x) x[[i]])))
corr75 = do.call(cbind, corr75)
corr75 = data.frame(corr75, stringsAsFactors = F)
colnames(corr75) <- c("true W", paste0("zinb k=", 1:2), 
                      "PCA (k=2)", "PCA TC (k=2)", "PCA TMM (k=2)",
                      "PCA FQ (k=2)",
                      'ZIFA (k=2)', 'ZIFA TMM (k=2)', 'ZIFA FQ (k=2)')
corr75$pzero = .75
boxplot(corr75[,1:10], main="Correlation between true and estimated sample distances in W\npzero = 0.75", border=c(3, 1, 2, rep(1,10)), xlab="method", ylab="Correlation", las=2)
abline(h = 1, lty = 2)
```
...
```{r sil45}
load("./datasets/simAllen_var2_z45_dist.rda")
sil45 <- lapply(12:length(res[[1]]), function(i){
  rowMeans(sapply(res, function(x) x[[i]]))
})
sil45 = do.call(cbind, sil45)
sil45 = data.frame(sil45,stringsAsFactors = F)
colnames(sil45) <- c("true W", paste0("zinb k=", 1:3), 
                      "PCA (k=2)", "PCA TC (k=2)", "PCA TMM (k=2)",
                      "PCA FQ (k=2)",
                      'ZIFA (k=2)', 'ZIFA TMM (k=2)', 'ZIFA FQ (k=2)')
sil45$pzero = .45
boxplot(sil45[,1:11], main="Silhouette width of true labels\npzero = 0.45",
        border=c(3, 1, 2, rep(1,10)), xlab="", 
        ylab="Silhouette width", las=2)
boxplot(sil45[,1] - sil45[,1:11],
        main="Difference of Silhouette width of true labels\npzero = 0.45",
        border=c(3, 1, 2, rep(1,10)), xlab="",
        ylab="Silhouette width - True Silhouette width", las=2)
abline(h = 0, lty = 2)
...
```{r sil75}
load("./datasets/simAllen_var2_z75_dist.rda")
sil75 <- lapply(11:length(res[[1]]), function(i){
  rowMeans(sapply(res, function(x) x[[i]]))
})
sil75 = do.call(cbind, sil75)
sil75 = data.frame(sil75,stringsAsFactors = F)
colnames(sil75) <- c("true W", paste0("zinb k=", 1:2), 
                      "PCA (k=2)", "PCA TC (k=2)", "PCA TMM (k=2)",
                      "PCA FQ (k=2)",
                      'ZIFA (k=2)', 'ZIFA TMM (k=2)', 'ZIFA FQ (k=2)')
sil75$pzero = .75
boxplot(sil75[,1:10], main="Silhouette width of true labels\npzero = 0.75",
        border=c(3, 1, 2, rep(1,10)), xlab="", 
        ylab="Silhouette width", las=2)
boxplot(sil75[,1] - sil75[,1:10],
        main="Difference of Silhouette width of true labels\npzero = 0.75",
        border=c(3, 1, 2, rep(1,10)), xlab="",
        ylab="Silhouette width - True Silhouette width", las=2)
abline(h = 0, lty = 2)
...
```{r pca25}
load("./datasets/simAllen_var2_z25.rda")
load("./datasets/simAllen_var2_z25_zifaFQ.rda")
load("./datasets/simAllen_var2_z25_fitted.rda")
biotrue = factor(bio)
fit = fittedSim[[2]][[1]][[2]][[4]]
...
load("./datasets/simAllen_var2_z45.rda")
load("./datasets/simAllen_var2_z45_zifaFQ.rda")
load("./datasets/simAllen_var2_z45_fitted.rda")
biotrue = factor(bio)
fit = fittedSim[[2]][[1]][[2]][[4]]
fq <- betweenLaneNormalization(t(simData[[1]]$counts), which="full")
pca <- prcomp(t(log1p(fq)))
...
load("./datasets/simAllen_var2_z75.rda")
load("./datasets/simAllen_var2_z75_zifaFQ.rda")
load("./datasets/simAllen_var2_z75_fitted.rda")
biotrue = factor(bio)
fit = fittedSim[[2]][[1]][[2]][[4]]
fq <- betweenLaneNormalization(t(simData[[1]]$counts), which="full")
pca <- prcomp(t(log1p(fq)))
...
# edgeR
nb25 = fitNB('./datasets/simAllen_var2_z25.rda')
