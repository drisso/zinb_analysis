...
# BIAS, VARIANCE
#####################
pref = 'sims/datasets/simZeisel_100_a1_offs0_seed9128'
# bias 
biasList = computeBiasList(pref)
...
save(bias, file = paste0(pref, '_bias.rda'))

# variance
varianceList = computeVarianceList(pref)
...
save(variance, file = paste0(pref, '_variance.rda'))
