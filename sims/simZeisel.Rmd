...
save(simModel, simData, 
     file = "~/Documents/BRAIN/gitrepo/zinb_analysis/sims/datasets/sim_zeisel_lowZero.rda")
```
...
save(simModel_more0, simData_more0,
     file = "~/Documents/BRAIN/gitrepo/zinb_analysis/sims/datasets/sim_zeisel_highZero.rda")
```
